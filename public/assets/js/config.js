...
const SEAT_LAYOUT = [
  ...
  // ---------- โซนธรรมดาสีเขียว (A3/C3) — ส่วน B3 กลาง ยกระดับเป็นราคา/สีเดียวกับโซนม่วง (type: "purple")
  //            id ยังใช้คำว่า "green-*" เป็นชื่อภายในเท่านั้น ห้ามแก้เพราะผูกกับที่นั่งที่จองไปแล้ว ----------
  { id: "green-right",  name: "โซน A3 · ธรรมดาฝั่งขวา", type: "green", rows: { J: 17, K: 17, L: 18, M: 18 } },
  { id: "green-center", name: "โซน B3 · ธรรมดากลาง",    type: "purple", rows: { J: 19, K: 19, L: 20, M: 20 } },
